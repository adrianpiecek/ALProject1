page 50127 "EIP District Sub To Deliever"
{
    ApplicationArea = All;
    Caption = 'Orders To Deliever';
    PageType = ListPart;
    SourceTable = "EIP Transport Order";
    SourceTableView=sorting("Order Date and Time")order(ascending) where ("Order Status"=const("To Deliever")) ;
